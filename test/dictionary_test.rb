...
class DictionaryTest < Test::Unit::TestCase
  ...
  VALID_UNITS = ['main sleeps', 'kilograms', 'years', 'days', 'minutes', 'counts', 'breaks', 'bouts', 'metabolic equivalents', 'kilocalories', 'kilocalories per hour', 'counts', 'counts per minute', '']
